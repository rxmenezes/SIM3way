...
adj.bhfdr <- function(pvals,myvar,my.cutoff=0.05)
{
...
segments(0,my.cutoff,ngenes,my.cutoff,lty="dashed")
...
adj.byfdr <- function(pvals,myvar,my.cutoff=0.05)
{
adj.pvals <- p.adjust(pvals,method="BY")
ngenes <- length(pvals)
